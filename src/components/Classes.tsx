      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center slide-up">
          <div className="flex flex-col items-center justify-center p-10">
            <Frown className="w-16 h-16 text-primary mb-6 animate-bounce" />
            <p className="text-2xl font-semibold text-neutral-700 animate-pulse">
              We are not conducting classes right now.
            </p>
            <p className="text-lg text-neutral-500 mt-3 animate-pulse">
              Classes will start soon in the future.
            </p>
          </div>
        </div>

        {/* Footer (Call to Action placeholder) */}
